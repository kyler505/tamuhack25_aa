...
// import a library for random number generation
...
export class Generator {
  ...
  flight(origin: Airport, destination: Airport, departureTime: DateTime): Flight {
    ...
    // given an average of 474.83, the price should be between 305.47 and 644.19
    const price = 474.83 + this.random(-1, 1) * margin_of_error / 100;
    ...
    return {
      ...
      origin,
      destination,
      price,// this is added, want to implement a price for each flight
      distance,
      duration,
